...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-300 font-sans">
            ...
            <div className="mb-6">
              <Breadcrumbs
                items={[
                  ...
                  {
                    label: selectedTransformation.title,
                    active: true
                  }
                ]}
                className="mb-4"
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <div className={`w-2 h-2 rounded-full ${primaryImageUrl ? 'bg-green-500' : 'bg-gray-600'}`} />
                  <span>上传图片</span>
                </div>
                <div className="flex-1 h-0.5 bg-gray-700" />
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <div className={`w-2 h-2 rounded-full ${isLoading ? 'bg-orange-500 animate-pulse' : generatedContent ? 'bg-green-500' : 'bg-gray-600'}`} />
                  <span>生成结果</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col p-6 bg-gray-950/60 backdrop-blur-lg rounded-xl border border-white/10 shadow-2xl shadow-black/20">
                ...
                {isLoading && (
                  <div className="flex-grow flex items-center justify-center">
                    <LoadingSpinner 
                      ...
                      showProgress={true}
                      progress={loadingMessage.includes('Step 1') ? 33 : loadingMessage.includes('Step 2') ? 66 : 10}
                    />
                  </div>
                )}
                {error && (
                ...
                {!isLoading && !error && !generatedContent && (
                  <div className="flex-grow flex flex-col items-center justify-center text-center text-gray-500">
                    ...
                    <p className="mt-2">Image shows here soon... 图片将在此展示</p>
                  </div>
                )}
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-black/60 border-t border-white/10 py-6 mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <div className="flex items-center gap-6">
              <a href="/pages/disclaimer.html" target="_blank" rel="noopener noreferrer" className="hover:text-gray-200 transition-colors">免责声明</a>
              <a href="/pages/privacy.html" target="_blank" rel="noopener noreferrer" className="hover:text-gray-200 transition-colors">隐私说明</a>
            </div>
            <div className="flex items-center gap-2">
              <span>联系我们:</span>
              <a href="mailto:info@nanobanana.bar" className="text-orange-400 hover:text-orange-300 transition-colors">
                info@NanoBanana.bar
              </a>
            </div>
          </div>
